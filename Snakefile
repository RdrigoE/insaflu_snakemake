...
def get_output_sample_se(config_user):
    return(
...
def get_output_sample_pe(config_user):
    return(
...
def get_output_files_se(config_user):
    return(
        expand("samples/{sample}/raw_fastqc/{sample}_fastqc.html", sample=config_user['samples']),
        expand("samples/{sample}/trimmed_fastqc/{sample}.trimmed_fastqc.html", sample=config_user['samples']),
        #expand("samples/{sample}/spades/contigs.fasta", sample=config_user['samples']),
        expand("samples/{sample}/abricate/abricate_{sample}.csv", sample=config_user['samples']),
        #expand("align_samples/{sample}/snippy/snps.consensus.fa",project=config_user['project_name'], sample=config_user['samples']),
        #expand("projects/{project}/main_result/consensus/{sample}__SARS_COV_2_consensus.fasta", sample=config_user['samples'], project=config_user['project_name']),
        #expand("projects/{project}/main_result/AllConsensus.fasta", project=config_user['project_name']),
        #expand("projects/{project}/main_result/coverage/{sample}_coverage.tab", sample=config_user['samples'], project=config_user['project_name']),
        expand("projects/{project}/main_result/coverage.csv",project=config_user['project_name']),
        #expand("projects/{project}/main_result/freebayes/{sample}_var.vcf", sample=config_user['samples'], project=config_user['project_name']),
        expand("projects/{project}/main_result/snpeff/{sample}_snpeff.vcf",sample=config_user['samples'], project=config_user['project_name']),
        expand("projects/{project}/main_result/mafft/mafft.fasta", sample=config_user['samples'], project=config_user['project_name']),
        expand("projects/{project}/main_result/{ref}/Alignment_aa_{ref}_{protein}.fasta",project=config_user['project_name'],ref=config_user["ref"],protein=config_user["proteins"]),
        expand("projects/{project}/main_result/fasttre/tree", sample=config_user['samples'], project=config_user['project_name']), 
        expand("projects/{project}/main_result/{ref}/Alignment_aa_{ref}_{protein}_tree.tree", project=config_user['project_name'],ref=config_user["ref"],protein=config_user["proteins"]),

    )

def get_output_files_pe(config_user):
    return(
        expand("samples/{sample}/raw_fastqc/{sample}_{direction}_fastqc.html", sample=config_user['samples'],direction=["1","2"]), #generalizar
        expand("samples/{sample}/trimmed_fastqc/{sample}_{direction}.trimmed_fastqc.html", sample=config_user['samples'],direction=["1","2"]),
        #expand("samples/{sample}/spades/contigs.fasta", sample=config_user['samples']),
        ...
        #expand("projects/{project}/main_result/consensus/{sample}__SARS_COV_2_consensus.fasta", sample=config_user['samples'], project=config_user['project_name']),
        #expand("projects/{project}/main_result/AllConsensus.fasta", project=config_user['project_name']),
        #expand("projects/{project}/main_result/coverage/{sample}_coverage.csv", sample=config_user['samples'], project=config_user['project_name']),
        expand("projects/{project}/main_result/coverage.csv",project=config_user['project_name']),
        #expand("projects/{project}/main_result/freebayes/{sample}_var.vcf", sample=config_user['samples'], project=config_user['project_name']),
        expand("projects/{project}/main_result/snpeff/{sample}_snpeff.vcf",sample=config_user['samples'], project=config_user['project_name']),
        expand("projects/{project}/main_result/mafft/mafft.fasta", sample=config_user['samples'], project=config_user['project_name']),
        expand("projects/{project}/main_result/{ref}/Alignment_aa_{ref}_{protein}.fasta",project=config_user['project_name'],ref=config_user["ref"],protein=config_user["proteins"]),
        expand("projects/{project}/main_result/{ref}/Alignment_aa_{ref}_{protein}_mafft.fasta",project=config_user['project_name'],ref=config_user["ref"],protein=config_user["proteins"]),
        expand("projects/{project}/main_result/fasttre/tree", sample=config_user['samples'], project=config_user['project_name']), 
        expand("projects/{project}/main_result/{ref}/Alignment_aa_{ref}_{protein}_tree.tree", project=config_user['project_name'],ref=config_user["ref"],protein=config_user["proteins"]),
